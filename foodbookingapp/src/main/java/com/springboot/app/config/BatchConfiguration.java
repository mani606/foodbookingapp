...
import com.springboot.app.batchprocessing.JobCompletionNotificationListener;
import com.springboot.app.batchprocessing.MenuItemProcessor;
...
public class BatchConfiguration { 
	...
	public FlatFileItemReader<Item> reader() { 
		return new FlatFileItemReaderBuilder<Item>() 
				...
				.delimited() 
				.names(new String[]{"vendorname","itemcode","itemname","priceperitem"}) 
	...
	public JdbcBatchItemWriter<Item> writer(DataSource dataSource) { 
		return new JdbcBatchItemWriterBuilder<Item>() 
				...
				.sql("INSERT INTO item (resturantname,itemcode ,itemname, priceperitem) VALUES (:vendorname, :itemcode, :itemname, :priceperunit)") 
				.dataSource(dataSource)
				.build(); 
	} 
